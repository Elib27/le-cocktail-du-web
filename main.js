...
lenis.on('scroll', (e) => {
  console.log(e)
  animatedGlassOnScroll(e.animatedScroll, glassMesh)
})
...
function animatedGlassOnScroll(yScroll, glassMesh) {
  if (glassMesh) {
    glassMesh.rotation.x = yScroll / 500;
    glassMesh.rotation.y = yScroll / 500;
  }
}
